...
export default function BlogPost({ params }) {
    ...
    return (
        <>
            <Head>
                <title>{blog ? `${blog.heading} | Flipr News Blog` : 'Blog Post | Flipr News'}</title>
                <meta name="description" content={blog ? blog.text.slice(0, 155) + '...' : 'Read this blog post on Flipr News'} />
                <meta property="og:title" content={blog?.heading} />
                <meta property="og:description" content={blog ? blog.text.slice(0, 155) + '...' : 'Read this blog post'} />
                <meta property="og:type" content="article" />
                <meta property="article:published_time" content={blog?.dateTime} />
                <meta property="article:author" content={blog?.userId.name} />
                <link rel="canonical" href={`/blog/${React.use(params).id}`} />
            </Head>
            ...
            <main className="min-h-screen bg-gray-50" role="main">
                ...
                <article itemScope itemType="http://schema.org/BlogPosting" className="max-w-4xl mx-auto px-4 py-8">
                    <meta itemProp="datePublished" content={blog?.dateTime} />
                    <meta itemProp="author" content={blog?.userId.name} />
