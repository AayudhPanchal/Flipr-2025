...
export default function BlogPage() {
  ...
  return (
    <>
      <Head>
        <title>Blog Posts | Flipr News</title>
        <meta name="description" content="Read our latest blog posts about news, analysis, and insights on various topics." />
        <meta property="og:title" content="Blog Posts | Flipr News" />
        <meta property="og:description" content="Read our latest blog posts about news, analysis, and insights on various topics." />
      ...
      <main className="min-h-screen bg-gray-50" role="main">
        ...
        <section className="container mx-auto px-4 py-8 md:py-12" role="feed" aria-label="Blog posts">
          {isLoading ? (
            // Loading skeleton
